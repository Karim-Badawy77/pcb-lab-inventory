...
const parse = (body) => { const payload = { ...body }; for (const key of ['field_test_date', 'repairer', 'spare_part', 'updates']) if (typeof payload[key] === 'string') payload[key] = JSON.parse(payload[key]); return payload; };
