...
<template>
    <form class="item-form" novalidate @submit.prevent="submit">
        ...
        <section class="form-section">
            ...
            <div
                class="segmented"
                :class="{ 'segmented--three': creationMode }"
                role="radiogroup"
            ...
            >
                ...
                <label v-if="creationMode">
                    <input
                        type="radio"
                        name="state"
                        value="under_repair"
                        :checked="form.under_repairment"
                        @change="setUnderRepair"
                    />
                    <span>Under repair</span>
                </label>
            </div>
            <div v-if="form.under_repairment" class="notice-panel">
                <strong>Lab repair queue</strong
                ><span
                    >This item is stored in the lab while it is under
                    repair.</span
                >
            </div>
        ...
        <section class="form-section">
            ...
            <label class="field"
                ...
                ><input
                    ...
                    name="tags"
                    placeholder="controller, tested, rev-b"
            /></label>
            <label class="field"
        ...
        <ImagePicker
            :existing-images="initialItem.images || []"
            :error="errors.images"
